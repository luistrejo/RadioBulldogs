...
import bulldogs.luistrejo.com.radiobulldogs.TopRatedFragment;
...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View itemView = inflater.inflate(R.layout.listview_item, parent, false);
        // Get the position
        ...
        usuario.setText(resultp.get(TopRatedFragment.usuario));
        comentario.setText(resultp.get(TopRatedFragment.comentario));
